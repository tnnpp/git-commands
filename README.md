...
## Branch and Merge
 1. create a branch
   ...
   ```
   2. check what is the current branch 
   ```
   git branch
   ```
   3. merge the branch
   ...
   git merge <branch>
   ```
   4. check which file are un merged
   ```
   git status
   ```
...
---
## Resources
* [Gihub cheat sheet](https://training.github.com/downloads/github-git-cheat-sheet/) summarize of Github's basic
